...
describe('generateClient', () => {
  ...
  describe('header', () => {
    it('should include auto-generated warning comment', () => {
      ...
      expect(result).toContain('// Auto-generated by gsq - DO NOT EDIT')
    })
  })
  ...
  describe('imports', () => {
    it('should import createSheetsDB, MockAdapter, and DataStore from gas-sheets-query', () => {
      ...
      expect(result).toContain("import { createSheetsDB, MockAdapter, DataStore } from 'gas-sheets-query'")
    })
  ...
  describe('createDB function', () => {
    it('should generate createDB factory function', () => {
      ...
      expect(result).toContain('User: DataStore<User>')
    })
  ...
  describe('createTestDB function', () => {
    ...
    it('should create MockAdapter for each table', () => {
      ...
      expect(result).toContain('Post: new MockAdapter<Post>()')
      expect(result).toContain('User: new MockAdapter<User>()')
    })
  })
  ...
  describe('integration', () => {
    it('should generate complete client code', () => {
      ...
      // createDB
      expect(result).toContain('export function createDB(stores: {')
      expect(result).toContain('Post: DataStore<Post>')
      expect(result).toContain('User: DataStore<User>')
