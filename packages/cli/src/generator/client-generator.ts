...
const HEADER = '// Auto-generated by gsq - DO NOT EDIT'
...
function generateLibraryImport(hasTables: boolean): string {
  if (!hasTables) {
    return "import { createSheetsDB, MockAdapter } from 'gas-sheets-query'"
  }
  return "import { createSheetsDB, MockAdapter, DataStore } from 'gas-sheets-query'"
}
